 ...
 * @author vane_
 */
public class dietaDiabetico extends javax.swing.JFrame {

    /**
     * Creates new form dietaDiabetico
     */
    public dietaDiabetico() {
        initComponents();
        this.setTitle("HealthyLife");
        this.setLocationRelativeTo(dietaDiabetico.this);
        ...
        String[] desayuno = {"DESAYUNO", "Betabel", "manzana", "Avena", "Huevo", " "};
        model.addRow(desayuno);
        String[] colacion = {"COLACIÖN", "Tomate ", " ", "Tortilla integral", "Queso panela", " "};
        model.addRow(colacion);
        String[] comida = {"COMIDA", "Lechuga", "Agua de fruta", "Arroz integral", "Pollo", "Guacamole"};
        model.addRow(comida);
        String[] colacion2 = {"COLACIÓN", " ", "Platano", "Granola", "Yoghurt", "Chia"};
        model.addRow(colacion2);
        String[] cena = {"CENA", "Lechuga", "Tomate", "Pan integral", "Jamón de pavo", "Aguacate"};
        model.addRow(cena);
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Dieta para diabeticos");
    ...
    public void gui5() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dietaDiabetico().setVisible(true);
