 ...
 * @author vane_
 */
public class dieta3 extends javax.swing.JFrame {

    /**
     * Creates new form dieta3
     */
    public dieta3() {
        initComponents();
        this.setTitle("HealthyLife");
        this.setLocationRelativeTo(dieta3.this);
        ...
        String[] desayuno = {"DESAYUNO", "lechuga", "Jugo de fruta", "Tortilla de nopal", " ", "Guacamole y chia"};
        model.addRow(desayuno);
        String[] colacion = {"COLACIÓN", "Jicama", "Sandia", " ", " ", " "};
        model.addRow(colacion);
        String[] comida = {"COMIDA", "Apio y tomate", "Jugo de fruta", "Tostada horneada", "Lentejas", "Aguacate"};
        model.addRow(comida);
        String[] colacion2 = {"COLACION", " ", "Platano", "Pan integral", " ", "Crema de cacahuate"};
        model.addRow(colacion2);
        String[] cena = {"CENA", " ", "Manzana", "Avena", "Leche", ""};
        model.addRow(cena);
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Dieta para peso alto");
